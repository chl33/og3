...
const char* kApparent_power = "apparent_power";
const char* kAqi = "aqi";
const char* kArea = "area";
const char* kAtmospheric_pressure = "atmospheric_pressure";
const char* kBattery = "battery";
const char* kBlood_glucose_concentration = "blood_glucose_concentration";
const char* kCarbon_dioxide = "carbon_dioxide";
const char* kCarbon_monoxide = "carbon_monoxide";
const char* kCurrent = "current";
const char* kDataRate = "data_rate";
const char* kDataSize = "data_size";
const char* kDate = "date";
const char* kDistance = "distance";
const char* kDuration = "duration";
const char* kEnergy = "energy";
const char* kEnergyDistance = "energy_distance";
const char* kEnergyStorage = "energy_storage";
const char* kEnum = "enum";
const char* kFrequency = "frequency";
const char* kGas = "gas";
const char* kHumidity = "humidity";
const char* kIlluminance = "illuminance";
const char* kIrradiance = "irradiance";
const char* kMoisture = "moisture";
const char* kMonetary = "monetary";
const char* kNitrogenDioxide = "nitrogen_dioxide";
const char* kNitrogenMonoxide = "nitrogen_monoxide";
const char* kNitrousOxide = "nitrous_oxide";
const char* kOzone = "ozone";
const char* kPh = "ph";
const char* kPm1 = "pm1";
const char* kPm25 = "pm25";
const char* kPm4 = "pm4";
const char* kPm10 = "pm10";
const char* kPowerFactor = "power_factor";
const char* kPower = "power";
const char* kPrecipitation = "precipitation";
const char* kPrecipitationIntensity = "precipitation_intensity";
const char* kPressure = "pressure";
const char* kReactiveEnergy = "reactive_energy";
const char* kReactivePower = "reactive_power";
const char* kSignalStrength = "signal_strength";
const char* kSoundPressure = "sound_pressure";
const char* kSpeed = "speed";
const char* kSulphurDioxide = "sulphur_dioxide";
const char* kTemperature = "temperature";
const char* kTemperatureDelta = "temperature_delta";
const char* kTimestamp = "timestamp";
const char* kVolatileOrganicCompounds = "volatile_organic_compounds";
const char* kVolatileOrganicCompoundsParts = "volatile_organic_compounds_parts";
const char* kVoltage = "voltage";
const char* kVolume = "volume";
const char* kVolumeFlowRate = "volume_flow_rate";
const char* kVolumeStorage = "volume_storage";
const char* kWater = "water";
const char* kWeight = "weight";
const char* kWindDirection = "wind_direction";
const char* kWindSpeed = "wind_speed";
}  // namespace sensor

namespace binary_sensor {
const char* kBatteryCharging = "battery_charging";
const char* kCarbonMonoxide = "carbon_monoxide";
const char* kCold = "cold";
const char* kConnectivity = "connectivity";
const char* kDoor = "door";
const char* kGarageDoor = "garage_door";
const char* kGas = "gas";
const char* kHeat = "heat";
const char* kLight = "light";
const char* kLock = "lock";
const char* kMoisture = "moisture";
const char* kMotion = "motion";
const char* kMoving = "moving";
const char* kOccupancy = "occupancy";
const char* kOpening = "opening";
const char* kPlug = "plug";
const char* kPower = "power";
const char* kPresence = "presence";
const char* kProblem = "problem";
const char* kRunning = "running";
const char* kSafety = "safety";
const char* kSmoke = "smoke";
const char* kSound = "sound";
const char* kTamper = "tamper";
const char* kUpdate = "update";
const char* kVibration = "vibration";
